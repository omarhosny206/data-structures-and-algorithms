...
{
    int numVertices = 6;
    vector<vector<int>> data = {{0, 1, -1}, {0, 2, 4}, {1, 0, -1}, {1, 2, 4}, {1, 4, 7}, {1, 3, 2}, {2, 0, 4}, {2, 1, 4}, {2, 3, 3}, {2, 4, 5}, {3, 2, 3}, {3, 1, 2}, {3, 4, 4}, {3, 5, 6}, {4, 1, 7}, {4, 2, 5}, {4, 3, 4}, {4, 5, 7}, {5, 3, 6}, {5, 4, 7}};
